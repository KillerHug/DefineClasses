...
public class MyCourse_Model {
    String course_id,course,banner,duration,lectures,course_fee,description;
    int rating;

    public MyCourse_Model(String course_id, String course, String banner, String duration, String lectures, String course_fee, String description) {
